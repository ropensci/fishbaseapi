...
class FBAppRoutes < Minitest::Test
  ...
  $heartbeat = "{\n  \"routes\": [\n    \"/docs\",\n    \"/heartbeat\",\n    \"/mysqlping\",\n    \"/comnames?<params>\",\n    \"/countref?<params>\",\n    \"/country?<params>\",\n    \"/diet?<params>\",\n    \"/ecology?<params>\",\n    \"/ecosystem?<params>\",\n    \"/faoareas/:id?<params>\",\n    \"/faoarref/:id?<params>\",\n    \"/fecundity?<params>\",\n    \"/fooditems?<params>\",\n    \"/genera/:id?<params>\",\n    \"/intrcase?<params>\",\n    \"/maturity?<params>\",\n    \"/morphdat?<params>\",\n    \"/morphmet?<params>\",\n    \"/occurrence?<params>\",\n    \"/oxygen?<params>\",\n    \"/popchar?<params>\",\n    \"/popgrowth?<params>\",\n    \"/poplf?<params>\",\n    \"/popll?<params>\",\n    \"/popqb?<params>\",\n    \"/poplw?<params>\",\n    \"/predats?<params>\",\n    \"/ration?<params>\",\n    \"/refrens?<params>\",\n    \"/reproduc?<params>\",\n    \"/species/:id?<params>\",\n    \"/spawning?<params>\",\n    \"/speed?<params>\",\n    \"/stocks?<params>\",\n    \"/swimming?<params>\",\n    \"/synonyms?<params>\",\n    \"/taxa?<params>\"\n  ]\n}"
  $comnames = {"autoctr"=>236404, "ComName"=>" ???????", "Transliteration"=>"Varimeen", "StockCode"=>135, "SpecCode"=>121, "C_Code"=>"356", "Language"=>"Telugu", "Script"=>"Telugu", "UnicodeText"=>"&#160;&#3125;&#3120;&#3135;&#3118;&#3142;&#3112;&#3149;", "NameType"=>"Vernacular", "PreferredName"=>0, "TradeName"=>0, "TradeNameRef"=>nil, "ComNamesRefNo"=>nil, "Misspelling"=>0, "Size"=>"juveniles and adults", "Sex"=>"females and males", "Language2"=>nil, "Locality2"=>nil, "Rank"=>3, "Remarks"=>nil, "SecondWord"=>nil, "ThirdWord"=>nil, "FourthWord"=>nil, "Entered"=>1029, "DateEntered"=>"2005-07-22 00:00:00 -0700", "Modified"=>393, "DateModified"=>"2011-07-27 00:00:00 -0700", "Expert"=>1432, "DateChecked"=>"2005-07-22 00:00:00 -0700", "Core"=>nil, "modifier1"=>nil, "modifier2"=>nil, "CLOFFSCA"=>0}
  ...
  def test_route_comnames
    get '/comnames'
    assert last_response.ok?
    assert_equal $comnames, JSON.parse(last_response.body)['data'][0]
  end
  ...
  def test_route_country
    get '/country'
    assert last_response.ok?
    p JSON.parse(last_response.body)['data'][0]
  ...
  # $occurrence =
  def test_route_occurrence
    get '/occurrence'
    assert last_response.ok?
    # assert_equal $occurrence, last_response.body
  end
